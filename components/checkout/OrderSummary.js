    ...
    >
      <div className="bg-secondary/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-4 sm:p-6 transition-all duration-300 w-full overflow-hidden">
        ...
        <div className="space-y-3 text-sm w-full">
          ...
          <div className="border-t border-white/20 dark:border-gray-600/20 pt-3 mt-3 transition-colors duration-300">
            <motion.div 
        ...
        <motion.div
          ...
          className="mt-6 pt-4 border-t border-white/20 dark:border-gray-600/20 transition-colors duration-300"
        >
        ...
        {shipping > 0 && subtotal < 50000 && (
          <motion.div
            ...
            className="mt-4 p-3 sm:p-4 bg-gradient-to-r from-yellow-50/10 to-orange-50/10 dark:from-yellow-900/10 dark:to-orange-900/10 rounded-xl border border-yellow-200/20 dark:border-yellow-600/20"
          >
